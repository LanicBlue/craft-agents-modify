...
const POLICIES: Record<CliDomainNamespace, CliDomainPolicy> = {
  label: {
    ...
    workspacePathScopes: ['.craft-agent/labels/**'],
    ...
    bashGuardPaths: ['.craft-agent/labels/**'],
  },
  source: {
    namespace: 'source',
    helpCommand: 'craft-agent source --help',
    workspacePathScopes: ['.craft-agent/sources/**'],
  ...
  skill: {
    ...
    workspacePathScopes: ['.craft-agent/skills/**'],
  ...
  automation: {
    ...
    workspacePathScopes: ['.craft-agent/automations.json', '.craft-agent/automations-history.jsonl'],
    ...
    bashGuardPaths: ['.craft-agent/automations.json', '.craft-agent/automations-history.jsonl'],
  },
  permission: {
    namespace: 'permission',
    helpCommand: 'craft-agent permission --help',
    workspacePathScopes: ['.craft-agent/permissions.json', '.craft-agent/sources/*/permissions.json'],
    ...
    bashGuardPaths: ['.craft-agent/permissions.json', '.craft-agent/sources/*/permissions.json'],
  },
  theme: {
    namespace: 'theme',
    helpCommand: 'craft-agent theme --help',
    workspacePathScopes: ['.craft-agent/workspace.json', '.craft-agent/theme.json', '.craft-agent/themes/*.json'],
    ...
    bashGuardPaths: ['.craft-agent/workspace.json', '.craft-agent/theme.json', '.craft-agent/themes/*.json'],
  },
}
